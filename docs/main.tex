...
% TODO inserire qui disegnino del modulo AC, con dentro Transmitter e Mobility Module
...
% magari questo va fatto prima della validazione?
% TODO The code correctly works
% TODO some images of the service time
% insomma verifico che il codice faccia davvero quello che deve fare a occhio
...
% TODO inoltre: ha senso quello che stiamo facendo? controlliamo l'handover convenience
