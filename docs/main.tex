...
In order to be completely sure of the validity of this early prediction, we decided to test the system with some bigger values for $t$, and discovered that these values leaded to indistinguishable results, both for end to end delay and queue length.

% TODO inserire qui immagini finali
