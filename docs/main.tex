...
% FROM HERE EVERYTHING IS WRONG -- vedere i conti di pietro con la nuova distribuzione teorica
\begin{centering}
  \texttt{TODO qui va sistemato il conto, magari mettiamoci i grafici delle pdf cdf}
\end{centering}
