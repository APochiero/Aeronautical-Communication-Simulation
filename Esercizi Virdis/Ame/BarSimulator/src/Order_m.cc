...
Order::Order(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->index = 0;
    this->timestamp = 0;
    this->status = 0;
...
Order::Order(const Order& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void Order::setTimestamp(double timestamp)
{
...
OrderDescriptor::OrderDescriptor() : omnetpp::cClassDescriptor("barsimulator::Order", "omnetpp::cPacket")
{
